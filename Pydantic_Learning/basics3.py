...
class test(BaseModel):
  name: str = Field(min_length=3, max_length=50) #name should be between 3 to 50 characters
  age: int = Field(gt = 18 , lt = 40) #age should be greater than 18 and less than 40
  ...
  allergies: Optional[list[str]] = None; Field(max_length=5) #for make the field optional ->allergies: Optional[list[str]] = None
